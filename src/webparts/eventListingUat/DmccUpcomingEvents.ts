export default class DmccUpcomingEvents
{
  //side html
        ...
        <div class="w-100 h-100 float-start d-flex flex-column align-items-start border">
          ...
          <div class="w-100 float-start p-3">
            <div class="row" style="padding:0 0 10px 0">
                        ...
                        <a href="_FirstSite/allevents/SitePages/Upcoming-Event-Details.aspx?env=WebView&UpcomingEventsID=#UpcomingEventsID"
                        class="text-lg gp-text-dark float-start m-0 lh-base text-decoration-none font-MyriadProBold">
                        #TITLE</a>
            </div>
            <div class=" ">
                      <span class="pe-1">Location:</span>
                        <span class="font-MyriadProBold">#LOCATION</span> 
    ...
    <a href="_FirstSite/allevents/SitePages/Upcoming-Event-Details.aspx?eventId=#LIKEID#scrollToComments"  class="d-flex align-items-center text-decoration-none ms-3">
          ...
          <div class="col-12 mb-4">
            ...
            <div class="col-box-icon sqbx-theme-2 d-flex flex-shrink-0 align-items-center justify-content-center">
             ...
             <p class="text-truncate text-uppercase m-0 font-MyriadProBold d-md-none">
                    ...
                    <div class="flex-grow-1 ps-3 pe-3 d-flex justify-content-between align-items-center">
                      ...
                      <div class="flex-shrink-0 d-flex align-items-center gap-2 details-filter-wrapper mt-3 mt-md-0">
                        <div class="float-start filter-search-input">
                          <input id="searchUpcomingEventsId" class="form-control form-control gp-input gp-input-search gp-input-search-inside"
                            type="text" placeholder="Search Events" aria-label="Search" />
                        </div>
              ...
              <div class="row gap-0 px-4 py-4 gy-4" id="UpcomingEventsListings">
              </div>			  
              <div class="w-100 float-start mb-4 px-4 d-flex justify-content-center">
                <button class="dmcc-btn float-start px-4 py-2 dmcc-bg-primary text-lg text-white" id="BtnLoadMoreUpcomingEvents" type="button">
                  Load More
                </button>
                <input type="hidden" id="LastLoadedUpcomingEventsID"/>
              </div>
            </div>
          </div>
        </div>
