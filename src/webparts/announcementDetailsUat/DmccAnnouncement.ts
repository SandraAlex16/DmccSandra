export default class DmccAnnouncement {
 ...
 <!-- <script src="https://unpkg.com/swiper/swiper-bundle.min.js"></script>    
  ...
  <link href="/sites/DMCC-Intranet-Prod/SiteAssets/css/layout.css" rel="stylesheet" />
            ...
            <div id='divWrapper' style='display:none;' class="col-box-wrapper w-100 float-start bg-white gp-shadow">
              ...
              <div class="col-box-title col-box-title-links d-flex flex-column flex-md-row bg-white position-relative">
                <div class="d-flex align-items-center gap-3">
                  ...
                  <img class="mw-px-60" src="_FirstSite/SiteAssets//images/icons/news-icon.png" />
                  </div>               
              ...
              <div class="w-100 float-start px-4 pt-4">
                <div  id="DMCCAnnoucementDetails"  class="row gx-xxl-5">
                ...
                <div class="col-12 col-lg-8 col-xl-9">
                  <div class="w-100 float-start mb-3 mt-2">
                    ...
                    <button id="btnAnnoAcknowledged" type="button"
                    class="dmcc-btn news-details-btn float-start px-4 py-2 text-sm mb-4 font-MyriadProBold cursor-pointer">Acknowledge</button>
                
                  </div>
                  <div  id="DMCCSideAnnoucements" class="col-12 d-none d-lg-flex flex-column col-lg-4 col-xl-3 news-right-box-wrapper custom-scroll-view">                 
