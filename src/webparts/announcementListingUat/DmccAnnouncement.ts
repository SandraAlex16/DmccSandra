            ...
            <div class="w-100 float-start p-3">
              ...
              <div class="d-flex w-100 float-start align-items-center mt-4">
                <a href="_FirstSite/SitePages/Announcement-Detail-Page.aspx?env=WebView&AnnouncementID=#AnnouncementID"
                  ...
                  <img class="mw-px-18 me-1 cursor-pointer announcement-like-icon" src="_FirstSite/SiteAssets/images/icons/like-icon.png" 
                       alt="Like" title="Like" data-like-id="#LIKEID" />
                <span class="text-sm announcement-like-count cursor-pointer" id="announcement-like-count-#LIKEID">Like (#LIKECOUNT)</span>
                  
        <a href="_FirstSite/SitePages/Announcement-Detail-Page.aspx?annoId=#LIKEID#scrollToComments"  class="d-flex align-items-center text-decoration-none ms-3">
