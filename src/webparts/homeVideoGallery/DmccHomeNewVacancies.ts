export default class DmccHomeNewVacancies
    ...
    <div class="col-box-wrapper w-100 mh-px-408 float-start h-100 bg-white gp-shadow d-flex flex-column">
        <div class="col-box-title d-flex bg-white position-relative flex-shrink-0">
          ...
          <div class="flex-grow-1 px-3 overflow-hidden d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center">
              ...
              <a href="https://dmccdxb.sharepoint.com${this._FirstSite}/SitePages/NewVacancies.aspx" class="mx-2 cursor-pointer"><img class="readmore-arrow position-relative cursor-pointer"
        ...
        <div class="w-100 float-start overflow-hidden py-1">
          <div class="w-100 h-100 float-start overflow-auto custom-scroll-view">
            <div id="homeNewVacancies" class="row gx-0">
...
public static newVacanciesElement = `
<div class="col-12 px-4 new-vacancies-row">
    <div class="w-100 d-flex align-items-center gp-border-primary py-3">
        <img class="bd-avatar border rounded-circle" src="#IMAGEURL" />
        <div class="ms-3 overflow-hidden">
            <p class="m-0 pb-2px text-sm lh-sm text-truncate gp-text-dark font-MyriadProLight">
            #POSITION
            </p>
            <p class="m-0 pb-2px text-sm lh-sm text-truncate gp-text-dark font-MyriadProLight">
            #DEPARTMENT.
