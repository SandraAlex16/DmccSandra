export default class DmccNews
{
  //side html

  //  <!-- public static _FirstSite="/sites/DMCC-Intranet-Prod";-->
      public static _FirstSite="/sites/DMCCDev";
  ...
  <!--<link href="${this._FirstSite}/SiteAssets/css/bootstrap.min.css" rel="stylesheet" />
  <link href="${this._FirstSite}/SiteAssets/css/custom.css" rel="stylesheet" />
  <link href="${this._FirstSite}/SiteAssets/css/custom.css.map" rel="stylesheet" />
  <link href="${this._FirstSite}/SiteAssets/css/custom.scss" rel="stylesheet" />
  <link href="${this._FirstSite}/SiteAssets/css/layout.css" rel="stylesheet" />
  <link href="${this._FirstSite}/SiteAssets/css/simple-calendar.css" rel="stylesheet" />
  <link href="${this._FirstSite}/SiteAssets/css/swiper-bundle.min.css" rel="stylesheet" />
  <link href="${this._FirstSite}/SiteAssets/css/jquery-ui.css" rel="stylesheet" />-->
  
    <div class="main-wrapper min-h-screen-container">
    <div class="container container-gp px-3 px-lg-4 clearfix">
      <div id="divWrapper" class="w-100 float-start pt-4">
        <div class="row">
          <div class="col-12 mb-4">
            <div class="col-box-wrapper w-100 float-start bg-white gp-shadow">
              <div class="col-box-title d-flex bg-white position-relative">
                <div class="col-box-icon sqbx-theme-2 d-flex flex-shrink-0 align-items-center justify-content-center">
                  <img class="mw-px-60" src="${this._FirstSite}/SiteAssets/images/icons/NewsFeed.png" />
                </div>
...
<!-- Comment section HTML start -->
                  ...
                  <div id="DMCCSideNews" class="col-12 d-none d-lg-flex flex-column col-lg-4 col-xl-3 news-right-box-wrapper custom-scroll-view">                 
