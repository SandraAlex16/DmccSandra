        ...
        <div class="row">
          <div class="col-12 mb-4">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                NEWS
                      ...
                      <div class="flex-shrink-0 d-flex align-items-center gap-2 details-filter-wrapper mt-3 mt-md-0">
                        <div class="float-start filter-search-input">
                          <input id="searchNewsId" class="form-control form-control gp-input gp-input-search gp-input-search-inside"
                            type="text" placeholder="Search News" aria-label="Search" />
                        </div>
              ...
              <div class="row gap-0 px-4 py-4 gy-4" id="NewsListings">
              </div>			  
              <div class="w-100 float-start mb-4 px-4 d-flex justify-content-center">
                <button class="dmcc-btn float-start px-4 py-2 dmcc-bg-primary text-lg text-white" id="BtnLoadMoreNews" type="button">
                  Load More
                </button>
                <input type="hidden" id="LastLoadedNewsID"/>
              </div>
            </div>
          </div>
        </div>
